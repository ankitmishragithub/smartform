  ...
  },
  {
    ...
    fields: [
      ...
      { type: "jspreadsheet", label: "📈 jSpreadsheet", icon: "📈", description: "Advanced jSpreadsheet ", defaultRows: 3, defaultCols: 4 },
        ...
        { type: "syncfusion-spreadsheet", label: "📈 Syncfusion Spreadsheet", icon: "📈", description: "Professional spreadsheet with advanced features", defaultRows: 15, defaultCols: 8 },
